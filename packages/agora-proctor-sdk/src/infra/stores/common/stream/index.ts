import { extractStreamBySourceType, extractUserStreams } from '@proctor/infra/utils/extract';
import { interactionThrottleHandler } from '@proctor/infra/utils/interaction';
import {
  AGServiceErrorCode,
  EduClassroomConfig,
  EduRoleTypeEnum,
...
import { SvgIconEnum } from '@proctor/ui-kit';
import { InteractionStateColors } from '@proctor/ui-kit/utilities/state-color';
...
export class StreamUIStore extends EduUIStoreBase {
  ...
  updateLocalPublishState(
    ...
    this.classroomStore.streamStore.updateLocalPublishState(streamState, fromScene);
  }
